...
e = emptyEstimator defaultQuantiles
e' = foldl (flip insert) e $ take 100_000 [1,1..]
...
We contacted the authors of the paper, and Graham Cormode provided us with a link to the latest work in this line[^followuppaper], and thankfully it also had publicly available code under the Apache foundation. In the new implementation, a summary is referred to as a ReqSketch, which stands for "Relative Error Quantile Sketch". We ported over the ReqSketch implementation to Haskell, and have it published as a package on Hackage[^hackage].
